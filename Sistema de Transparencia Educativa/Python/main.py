...
#creamos la funcion mostrar menu principal
def mostrar_menu():
...
#creamos la fncion para obtener seleciconar una opcion
def obtener_opcion():
...
#creamos la funcion para ejecutar la opcion elegida
...
#creo la funcion principal para ejecutar directamente el menu
def main():
